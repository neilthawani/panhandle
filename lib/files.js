...
var copyProjectContents = function(projectName) {
...
var editBaseTemplate = function(projectName) {
...
var printFolderContents = function(sourceDirName, cwd, projectName) {
...
module.exports = {
    initializeProject: async function(sourceDirName, cwd, projectName) {
        ...
        printFolderContents("blueprints", cwd, projectName);
    }
};
